...
export const latestObjects = {
  FR: [
    { title: 'Taxonomie de prompts', tag: 'NEW', time: '4 min', href: '/primitives' },
    { title: 'Knowledge Graph', tag: 'NEW', time: '6 min', href: '/knowledge-system' },
    { title: 'Patterns documentaires', tag: null, time: '5 min', href: '/patterns' },
    { title: 'Veille IA', tag: null, time: '3 min', href: '/knowledge-system' },
    { title: 'Decision Log', tag: null, time: '4 min', href: '/track-record' },
    { title: 'Prompt Library', tag: 'NEW', time: '5 min', href: '/primitives' },
    { title: 'AI Product Sprint', tag: null, time: '8 min', href: '/experience/education' },
  ],
  EN: [
    { title: 'Prompt Taxonomy', tag: 'NEW', time: '4 min', href: '/primitives' },
    { title: 'Knowledge Graph', tag: 'NEW', time: '6 min', href: '/knowledge-system' },
    { title: 'Documentation Patterns', tag: null, time: '5 min', href: '/patterns' },
    { title: 'AI Watch', tag: null, time: '3 min', href: '/knowledge-system' },
    { title: 'Decision Log', tag: null, time: '4 min', href: '/track-record' },
    { title: 'Prompt Library', tag: 'NEW', time: '5 min', href: '/primitives' },
    { title: 'AI Product Sprint', tag: null, time: '8 min', href: '/experience/education' },
  ],
...
export const pages = {
  home: {
    ...
    title: {
      FR: 'Je conçois des produits\nque les gens peuvent comprendre.',
      EN: 'I design products\npeople can understand.',
    },
    ...
    description: {
      FR: 'La documentation n\u2019est pas du contenu. C\u2019est l\u2019une des expériences produit les plus importantes.',
      EN: 'Documentation isn\u2019t content. It is one of the most important product experiences.',
    },
    chips: {
