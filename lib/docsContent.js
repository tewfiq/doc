...
export const shared = {
  ...
  footerSentence: {
    FR: 'Construit avec curiosité. Structuré par la documentation. Déployé avec Mistral Vibe.',
    EN: 'Built with curiosity. Structured through documentation. Shipped with Mistral Vibe.',
  },
  metadata: {
    FR: [
...
export const navGroups = [
  ...
  },
  {
    ...
    items: ['principles', 'foundations', 'tokens', 'doDont'],
  },
  {
    title: { FR: 'Système', EN: 'System' },
    items: ['knowledgeSystem', 'trackRecord', 'patterns'],
  },
  {
...
export const pages = {
  home: {
    ...
    title: {
      FR: 'Je transforme la complexité\nen systèmes clairs.',
      EN: 'I turn complexity\ninto clear systems.',
    },
    eyebrow: { FR: 'DESIGNER PRODUIT · DOCUMENTATION · IA', EN: 'PRODUCT DESIGNER · DOCUMENTATION · AI' },
    subtitle: {
      FR: 'Design systems, documentation et apprentissages pour aider les équipes à comprendre et construire plus vite avec l’IA.',
      EN: 'Design systems, documentation and learning experiences that help teams understand and build faster with AI.',
    },
    secondary: { FR: 'Cette page est une démonstration du format lui-même.', EN: 'This page is a demonstration of the format itself.' },
    chips: {
      FR: ['Créé avec Mistral Vibe', 'Paris', 'Disponible / Available', 'Knowledge Engineering', 'Version 1.0'],
      EN: ['Built with Mistral Vibe', 'Paris', 'Available / Disponible', 'Knowledge Engineering', 'Version 1.0'],
    },
    proof: {
      FR: [
        { value: '10+', label: 'ans de design produit' },
        { value: '1 500+', label: 'étudiants formés' },
        { value: '1 128', label: 'solutions d’IA documentées' },
        { value: '4 655+', label: 'contributions GitHub' },
      ],
      EN: [
        { value: '10+', label: 'years Product Design' },
        { value: '1,500+', label: 'students trained' },
        { value: '1,128', label: 'AI solutions documented' },
        { value: '4,655+', label: 'GitHub contributions' },
      ],
    },
    ctas: {
      primary: { FR: 'Réserver un échange', EN: 'Book a call', href: shared.ctaUrl },
      secondary: { FR: 'Explorer la documentation', EN: 'Explore the documentation', href: '/knowledge-system' },
    },
    sections: [
      { id: 'metadata', title: { FR: 'En bref', EN: 'In brief' } },
      { id: 'intro-callout', title: { FR: 'Point de départ', EN: 'Starting point' } },
      { id: 'start-here', title: { FR: 'Pour commencer', EN: 'Start here' } },
  ...
  knowledgeSystem: {
    ...
    subtitle: {
      FR: 'Une base structurée sur l’IA produit.',
      EN: 'A structured AI product knowledge base.',
    },
    sections: [
